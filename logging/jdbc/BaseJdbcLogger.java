...
public abstract class BaseJdbcLogger {
  ...
  // 记录了Statement与PreparedStatement接口中与执行SQL语句相关的方法
  ...
  // 记录了PreparedStatement.set(*)方法设置的key对
  private final List<Object> columnNames = new ArrayList<Object>();
  
  // 记录了PreparedStatement.set(*)方法设置的value对
  ...
  static {
	// 初始化PreparedStatement接口中定义的常用的set(*)方法
    ...
    // 初始化了Statement与PreparedStatement接口中与执行SQL语句相关的方法
  ...
  protected String getParameterValueString() {
	// PreparedStatement.set(*)方法设置的value对
    ...
    final String parameters = typeList.toString();// 字符串化
    return parameters.substring(1, parameters.length() - 1); // 截取字符串
  }
